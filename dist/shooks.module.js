...
function $991aba64de2bb6b0$var$useCookie(key, options) {
    ...
    var _c = $c7J86$useState(String(defaultValue)), value1 = _c[0], setValue = _c[1];
    $c7J86$useEffect(function() {
    ...
    var cook1 = $c7J86$useMemo(function() {
        var cook = "";
        if (expires) {
    ...
    var update = $c7J86$useCallback(function(value) {
...
var $991aba64de2bb6b0$export$2e2bcd8739ae039 = $991aba64de2bb6b0$var$useCookie;
